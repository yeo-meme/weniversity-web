...
import type { CourseFAQ } from "../../types/courseDetail/courseDetail";
      ...
      <div className="p-6 border border-gray-200 rounded-lg">
        <div className="flex justify-between">
          <span className="flex items-center font-medium text-gray-900">
            <span className="text-2xl text-blue-600 mr-3">Q{index + 1}.</span>
            {faq.question}
          </span>
...
const FAQSection: React.FC = () => {
  ...
  const [faqData, setFaqData] = useState<CourseFAQ[]>(initialFaqData);
