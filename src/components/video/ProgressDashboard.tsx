...
import { WatchProgress, UserProgressSummary, Chapter } from '@/types/video';
...
export const ProgressDashboard: React.FC<ProgressDashboardProps> = ({ 
  ...
  const [userProgress, setUserProgress] = useState<(WatchProgress & { chapterInfo: Chapter })[]>([]);
  ...
  useEffect(() => {
    const loadData = () => {
      try {
        ...
        const progressSummary = WatchProgressService.getUserProgressSummary(userId);
            ...
            return (
              ...
              >
                ...
                {hasProgress ? (
                  ...
                  <div className="text-xs text-gray-400 py-2">아직 시청하지 않음</div>
                )}
              </div>
            );
          })}
